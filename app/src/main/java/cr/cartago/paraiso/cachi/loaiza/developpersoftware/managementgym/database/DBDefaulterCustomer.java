...
public class DBDefaulterCustomer {
    ...
    public static final String SERVER_URL = "http://localhost/proyectos_web/AppGym/CachiFitnessCenter%20REST%20API%20PHP/php_rest_cachi_fitness_center/api/defaulter_customer/";
